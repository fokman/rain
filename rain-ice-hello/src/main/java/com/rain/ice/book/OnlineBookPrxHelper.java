...
public final class OnlineBookPrxHelper extends Ice.ObjectPrxHelperBase implements OnlineBookPrx
{
                                           ...
                                           IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_bookTick(msg, __ctx, __explicitCtx, __synchronous, 
                              new IceInternal.Functional_TwowayCallbackArg1<com.rain.ice.book.Message>(__responseCb, __exceptionCb, __sentCb)
                                  {
    ...
    {
        com.rain.ice.book.OnlineBookPrx __proxy = (com.rain.ice.book.OnlineBookPrx)__result.getProxy();
        Message __ret = null;
        try
        {
