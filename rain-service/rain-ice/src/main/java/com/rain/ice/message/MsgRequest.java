...
public class MsgRequest implements Cloneable,
    ...
    public java.util.Map<String, String> extraData;

    public int total;

    public java.util.Map<String, String> data;

    public java.util.Map<String, String> attr;
    ...
    public MsgRequest(String service, String method, int code, String msg, java.util.Map<String, String> extraData, int total, java.util.Map<String, String> data, java.util.Map<String, String> attr) {
