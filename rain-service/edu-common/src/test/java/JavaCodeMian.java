...
public class JavaCodeMian {
	...
	public static void main(String[] args) throws Exception {
		...
		for (String tableName : tableNames) {
			...
			sb.append("import com.zjhz.common.ice.v1.model.IceRequest;");
			sb.append("import com.zjhz.common.ice.v1.model.IceRespose;");
			sb.append("import com.zjhz.common.uitls.TestClientUtils;");
