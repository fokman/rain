...
public class Context implements java.lang.Cloneable, java.io.Serializable {
    ...
    public Context(String service, String method, java.util.Map<java.lang.String, java.lang.String> extraData, int code, String msg, int total, java.util.Map<java.lang.String, java.lang.String> data, java.util.Map<java.lang.String, java.lang.String> attr) {
    ...
    public Context(String service, String method, Map<String, String> extraData, Map<String, String> attr) {
        this.service = service;
        this.method = method;
        this.extraData = extraData;
        this.attr = attr;
    ...
    public static final long serialVersionUID = -1828065022L;
}
